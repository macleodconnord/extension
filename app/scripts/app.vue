        ...
        <div class="card-body">
          <div class="flex my-4">
            ...
            <label class="flex items-center gap-2">
              <span class="sr-only">
                {{ $helperbird_i18n('toggleExtension') || 'Toggle OpenDyslexic' }}
              </span>
              <input
                type="checkbox"
          ...
          <div class="my-4">
            <div
              ...
              role="list"
              :aria-label="$helperbird_i18n('fontOptions') || 'Font options'"
            >
              <template
                v-for="font in fonts"
                :key="font.title"
              >
                <button
                  :class="[
                    ...
                    {
                      'btn-active': font.title === selectedFont.title,
                    },
                  ]"
                  :aria-label="$helperbird_i18n('change_font_to_x', font.title)"
                  :title="$helperbird_i18n('change_font_to_x', font.title)"
                  type="button"
                  role="listitem"
